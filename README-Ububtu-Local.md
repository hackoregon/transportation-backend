...
2. `./1install-database-gis-services`. This installs all the Ubuntu packages you'll need. Please file an issue if it conflicts with things you already have installed!!
