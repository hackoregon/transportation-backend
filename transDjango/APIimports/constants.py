...
APIS = (
    (
        ...
        'http://gis.pdx.opendata.arcgis.com/datasets/93ed0b190bc6441fad1e48871b4c58d2_43.geojson'
    ),
    (
        'Capital Improv. Project - Lines',
        'http://gis.pdx.opendata.arcgis.com/datasets/698e0309785e4062b301190244e5a5e7_44.geojson'
    ),
    (
